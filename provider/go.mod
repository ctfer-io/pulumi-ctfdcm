...
require (
	...
	github.com/ctfer-io/go-ctfdcm v0.5.0 // indirect
	github.com/ctfer-io/terraform-provider-ctfd/v2 v2.8.0 // indirect
	...
	github.com/pulumi/pulumi/sdk/v3 v3.217.0 // indirect
