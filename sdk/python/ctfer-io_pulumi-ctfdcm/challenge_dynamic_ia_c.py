...
class ChallengeDynamicIaCArgs:
    def __init__(__self__, *,
                 ...
                 destroy_on_flag: Optional[pulumi.Input[bool]] = None,
                 function: Optional[pulumi.Input[str]] = None,
                 mana_cost: Optional[pulumi.Input[int]] = None,
        ...
        :param pulumi.Input[str] scenario_id: The file's ID of the scenario.
        :param pulumi.Input[int] value: The value (points) of the challenge once solved. It is mapped to `initial` under the hood, but displayed as `value` for consistency with the standard challenge.
        ...
        :param pulumi.Input[bool] destroy_on_flag: Whether to destroy the instance once flagged.
        ...
        :param pulumi.Input[int] mana_cost: The cost (in mana) of the challenge once an instance is deployed.
        ...
        :param pulumi.Input[bool] shared: Whether the instance will be shared between all players.
        ...
        :param pulumi.Input[int] timeout: The timeout (in seconds) after which the instance will be janitored.
        ...
        :param pulumi.Input[str] until: The date until the instance could run before being janitored.
        """
    ...
    @property
    @pulumi.getter
    def decay(self) -> pulumi.Input[int]:
        """
    ...
    @decay.setter
    def decay(self, value: pulumi.Input[int]):
    ...
    def destroy_on_flag(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def destroy_on_flag(self, value: Optional[pulumi.Input[bool]]):
    ...
    def mana_cost(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    @mana_cost.setter
    def mana_cost(self, value: Optional[pulumi.Input[int]]):
...
class ChallengeDynamicIaC(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            topics: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            until: Optional[pulumi.Input[str]] = None,
            value: Optional[pulumi.Input[int]] = None) -> 'ChallengeDynamicIaC':
        """
    ...
    @property
    @pulumi.getter(name="destroyOnFlag")
    def destroy_on_flag(self) -> pulumi.Output[bool]:
        """
        Whether to destroy the instance once flagged.
        """
        return pulumi.get(self, "destroy_on_flag")
    ...
    @property
    @pulumi.getter(name="manaCost")
    def mana_cost(self) -> pulumi.Output[int]:
        """
        The cost (in mana) of the challenge once an instance is deployed.
        """
        return pulumi.get(self, "mana_cost")
    ...
    @property
    @pulumi.getter
    def until(self) -> pulumi.Output[str]:
        """
        The date until the instance could run before being janitored.
        """
        return pulumi.get(self, "until")
