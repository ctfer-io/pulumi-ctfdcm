...
// The file's ID of the scenario.
func (o ChallengeDynamicIaCOutput) ScenarioId() pulumi.StringOutput {
	return o.ApplyT(func(v *ChallengeDynamicIaC) pulumi.StringOutput { return v.ScenarioId }).(pulumi.StringOutput)
}
