...
namespace Pulumi.Ctfdcm
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/ctfer-io/pulumi-ctfdcm/releases/download/v${VERSION}/";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Ctfdcm.version.txt");
    ...
    internal sealed class CtfdcmResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public CtfdcmResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
