PROJECT_NAME := CTFd-CM Pulumi provider
...
prepare::
	...
	if [[ "${OS}" != "Darwin" ]]; then \
		sed -i 's,github.com/ctfer-io/pulumi-ctfdcm,${REPOSITORY},g' provider/go.mod; \
...
tfgen:: install_plugins
	...
	sed -i 's/ctfer-io_pulumi-ctfd/ctfer_io_pulumi_ctfd/g' provider/cmd/${PROVIDER}/schema.json
